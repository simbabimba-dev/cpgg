...
class CouponController extends Controller
{
    ...
    private function requestRules(Request $request)
    {
        ...
        $rules = [
            ...
            // Accept -1 for unlimited uses, or a positive integer with at most 100 digits
            "max_uses" => [
                'required',
                'integer',
                function ($attribute, $value, $fail) {
                    // Accept -1 for unlimited, or a positive integer with at most 100 digits
                    if ($value !== -1 && ($value < 1 || strlen((string)$value) > 100)) {
