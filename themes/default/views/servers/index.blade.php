        ...
        <div class="container-fluid">
            ...
            <div class="mb-3 d-flex justify-content-md-start justify-content-center ">
                ...
                @if (Auth::user()->Servers->count() > 0 && !empty($phpmyadmin_url))
                    <a href="{{ $phpmyadmin_url }}" target="_blank" class="ml-2 btn btn-secondary"><i title="manage"
                        ...
                        <div class="pl-0 pr-0 col-xl-3 col-lg-5 col-md-6 col-sm-6 col-xs-12 card ml-sm-2 mr-sm-3"
                            ...
                            <div class="text-center card-footer">
                                <a href="{{ $pterodactyl_url }}/server/{{ $server->identifier }}" target="__blank"
                                    class="float-left ml-2 text-center btn btn-info" data-toggle="tooltip"
                                    data-placement="bottom" title="{{ __('Manage Server') }}">
                                    <i class="mx-2 fas fa-tools"></i>
                                </a>
                                <a href="{{ route('servers.show', ['server' => $server->id]) }}"
                                    class="mr-3 text-center btn btn-info" data-toggle="tooltip" data-placement="bottom"
                                ...
                                <button onclick="handleServerDelete('{{ $server->id }}');" target="__blank"
                                    class="float-right mr-2 text-center btn btn-danger" data-toggle="tooltip"
                                    data-placement="bottom" title="{{ __('Delete Server') }}">
