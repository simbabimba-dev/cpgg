            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    @if (app(App\Settings\ReferralSettings::class)->enabled)
                        <div class="mb-3 input-group">
                            <input type="text" value="{{ Request::get('ref') }}" class="form-control" name="referral_code"
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            @if ($website_settings->show_tos && $website_settings->show_privacy)
                                <div class="d-flex align-items-start mb-3">
                                    <div class="icheck-primary mb-0 mr-2">
                                        <input type="checkbox" id="agreeTerms" name="terms" value="agree">
                                        <label for="agreeTerms"></label>
                                    </div>
                                    <div>
                                        <label for="agreeTerms" class="mb-0" style="font-weight: normal; cursor: pointer;">
                                            {{__("I agree to the")}} <a target="_blank"
                                                href="{{ route('terms', 'tos') }}">{{__("Terms of Service")}}</a>
                                            {{ __('and') }} <a target="_blank"
                                                href="{{ route('terms', 'privacy') }}">{{__("Privacy Policy")}}</a>
                                        </label>
                                    </div>
                                </div>
                                @error('terms')
                                ...
                                @enderror
                            @elseif ($website_settings->show_tos)
                                ...
                                @enderror
                            @elseif ($website_settings->show_privacy)
                                <div class="icheck-primary">
